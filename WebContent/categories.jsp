						...
						<div class="product-articles">
							...
							<ul>
								<li>
									<div class="article">
										<p>
											<span>The Categories page At the
												Categories page the owners view and create product
												categories. If the accessing user is not an owner, the page
												should only display that this page is available to owners
												only. The page looks like the students page of the
												class example, in the sense that it displays the name and
												description of each category in text box and text area
												respectively, and offers Insert, Delete and
												Update buttons. Each category has a required unique
												...
												should be prevented, the Categories page should be
												redisplayed stating at the top that the requested data
												modification failure (referred to as data modification
												failure). It is optional but welcome to explain the
												...
												Delete button next to a product category if this
												...
												it is possible that the owner A sees a Delete button
												...
												delete c, since he still sees the Delete button.
												...
												the twobut the second will cost you a point :· [Preferred
												...
												category is not deletable any more. [Lesser Method] The
